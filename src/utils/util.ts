...
export function IsNullOrWhiteSpece(v: any){
 ...
 * 刷新菜单
 */
export function filterObjectMember<T = any>(target, filter?){
  filter = filter || function(v){
    return !IsNullOrWhiteSpece(v);
  };
  const obj: T = Object.create(null);
